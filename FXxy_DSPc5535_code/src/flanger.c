...
// * 
// * Function:     flanger                                                                        
// * Description:  Every input sample is stored in a buffer, the output is a weighted sum with the input sampled and a sample delayed by a periodically varying delay. 
// *               .
// *                                                                                     
...
/* The output is calculated as an even mix with delayed sample and the input sample */		
		output=(Int32) output + sample;
		output>>=1;
	return (Int16) output;	
